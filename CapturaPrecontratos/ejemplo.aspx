...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:HiddenField ID="dataHide" runat="server" />
    <!-- prestador-->
    <div class="container">
            ...
            <div class="col-sm-12">
                ...
                <div class="form-group col-sm-3">
                  ...
                  <!--  <input type="email" class="form-control">-->
                   ...
                   <asp:Button ID="Button2" runat="server" Text="Generar Municipio"  class="btn btn-link" />
                ...
                <div class="form-group col-sm-3">
                   ...
                   <!-- <input type="email" class="form-control" >-->
                    ...
                    <asp:SqlDataSource runat="server" ID="ssdl" ConnectionString='<%$ ConnectionStrings:PrecontratosConnectionString %>' SelectCommand="spGetMunicipios" SelectCommandType="StoredProcedure">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="dataHide" PropertyName="Value" DefaultValue="0" Name="estado" Type="Int32"></asp:ControlParameter>
                        </SelectParameters>
                    </asp:SqlDataSource>
                </div>
                <div class="form-group col-sm-3">
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="form-group col-sm-3">
                   ...
                   <asp:Button ID="Button4" runat="server" Text="Generar Partida y Unidad"  class="btn btn-link" />
                ...
                <div class="form-group col-sm-3">
                   ...
                   <asp:Button ID="Button3" runat="server" Text="Generar Departamento"  class="btn btn-link" />
                ...
                <div class="form-group col-sm-3">
            <asp:Button ID="Button1" runat="server" Text="Guardar"  class="btn btn-primary btn-lg" OnClick="btnGuardar_Click" /> <!--Enabled="false"   OnClick="btnGuardar_Click"-->
